...
public class Dto {
	...
	// 문의글 등록 생성자
	public Dto(String b_title, String b_content, String phone, String b_pw) {
		this.b_title = b_title;
		this.b_content = b_content;
		this.phone = phone;
		this.b_pw = b_pw;
	...
	// 게시글 상세보기 생성자
	public Dto(int b_num) {
		this.b_num = b_num;
	}
	
	// 답글 등록 생성자
	public Dto(String w_reply) {
		this.w_reply = w_reply;
	}
	
	// 답글 보기 생성자
	public Dto(String w_reply, String w_name ) {
		this.w_reply = w_reply;
		this.w_name = w_name;
	}
