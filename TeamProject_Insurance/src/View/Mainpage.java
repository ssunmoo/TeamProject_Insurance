...
///////////////////////////////////////////////////
	...
	public void update() {
		...
		if ( dto.getB_pw().equals(b_pw) ) {
			...
			System.err.println(" ▶ [오류] 비밀번호가 틀렸습니다. ");
		}
	} // update 메소드 종료
	...
	public void delete() {
		...
		if ( dto.getB_pw().equals(pw) ) {
			...
			if( result ) {
				...
				System.err.println(" ▶ [오류] 게시글 삭제 오류입니다.");
			}
		}
		else {
			System.err.println(" ▶ [오류] 비밀번호가 틀렸습니다. ");
	...
	public void board_view() {
		...
		if( dto == null ) {
			System.err.println(" ▶ [안내] 게시글이 없습니다");
			return;
		}
		System.out.println("▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬");
		...
		if( ch == 1 ) {
			...
			System.err.println(" ▶ [안내] 잘못된 번호입니다 다시 선택해 주세요");
		}
	} // board_view 메소드 종료
	...
	public void reply() {
		...
		if( result ) {
			...
			System.err.println(" ▶ [안내] 문의글 등록이 실패하였습니다 ");	
		}
